...
export namespace Calendars {
  ...
  export namespace Appointments {
     ...
     * }
     */
    export interface CreateUpdateDTO extends DTO {
      rrule?:  /** Recurrence Rule (RRULE) as per the iCalendar (RFC 5545) specification for recurring events. DTSTART is not required, instance ids are calculated on the basis of startTime of the event. The rrule only be applied if ignoreFreeSlotValidation is true. */;
    }

    export interface EditDTO extends DeepRequired<DTO> {}
  ...
  export namespace Groups {
     ...
     * ```
     */
    export type AllSuccessfulResponseDTO = {
      /**
       * the array of calendar groups ([{...}])
       *
       * @required
     ...
     * ```
     */
    export type ValidateSlugPostBodyDTO = {
      /**
       * the location id of the calendar group (ocQHyuzHvysMo5N5VsXc)
       *
       * @required
     ...
     * ```
     */
    export type ValidateSlugSuccessResponseDTO = {
      /**
     ...
     * ```
     */
    export type CreateSuccessfulResponseDTO = {
      /**
       * the calendar group object ({...})
       *
       * @required
     ...
     * ```
     */
    export type SuccessfulResponseDTO = {
      /**
     ...
     * ```
     */
    export type StatusUpdateParamsDTO = {
      /**
       * the status of the calendar group (true)
       *
       * @required
   ...
   */
  export type UpdateDTO =
    | Partial<CreateUserAssignedDTO>
    | Partial<CreateNonUserAssignedDTO>;
